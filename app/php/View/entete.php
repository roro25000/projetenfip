<html lang="en">
    ...
    <body>
        ...
        session_start();
        ?>
        <nav class="navbar navbar-expand-lg navbar-light bg-light entete">
                ...
                <ul class="navbar-nav mr-auto">
                    ...
                    <li class="nav-item">
                        <form id="deconnexionForm" action="espaceadherent.php" method="POST">
                            ...
                            <a class="nav-link" class="navbar-right" role="button" aria-haspopup="true" aria-expanded="false" href="javascript:{}" onclick="document.getElementById('deconnexionForm').submit();"><span class="ion-person active"></span> Deconnexion</a>
                        </form>
                    </li>
                    <?php
                    } else {
