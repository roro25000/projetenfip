...
<table border="2">
	...
	<?php
	$loc = "../../../public/ressources/csv/file.csv";
	...
	//	foreach ($tab2 as $str)
		...
		echo "</tr>"; */
                ...
                if($tab[5]=="0319125"){
                    ...
                    $match = $t->insertionMatch($tab[2],$_POST['equipe_id'],$t->InversionScore($tab[9]),$t->InversionSet($tab[10]),$t->InversionTotal($tab[11]),$tab[6],$creneauxID);               
                }
